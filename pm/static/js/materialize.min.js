    ...
    function (t) {
        ...
        t.extend(t.easing, {
            ...
            easeInOutBack: function (t) {
                return t < .5 ? e(2 * t, 2) * (7.189819 * t - s) / 2 : (e(2 * t - 2, 2) * ((s + 1) * (2 * t - 2) + s) + 2) / 2
            },
            ...
            function r(t, i, n, o) {
                ...
                function p() {
                    x = !0, (t != i || n != o) && function () {
                        for (var e = 0; g > e; ++e) k[e] = l(e * y, t, n)
                    }()
                }
                var h = 4,
                    f = .001,
                ...
                var k = b ? new Float32Array(g) : new Array(g),
                    x = !1,
                    C = function (e) {
                        return x || p(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(function (e) {
                            for (var i = 0, o = 1, a = g - 1; o != a && k[o] <= e; ++o) i += y;
                            var r = i + (e - k[--o]) / (k[o + 1] - k[o]) * y,
                                s = c(r, t, n);
                ...
                var w = function () {
                    ...
                    function r() {
                        function t(t) {
                            ...
                            function v() {
                                ...
                                if (o && n) l.emToPx = q.lastEmToPx, l.percentToPxWidth = q.lastPercentToPxWidth, l.percentToPxHeight = q.lastPercentToPxHeight;
                                    ...
                                    }), g.CSS.setPropertyValue(c, "paddingLeft", s + "em"), l.percentToPxWidth = q.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(c, "width", null, !0)) || 1) / s, l.percentToPxHeight = q.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(c, "height", null, !0)) || 1) / s, l.emToPx = q.lastEmToPx = (parseFloat(b.getPropertyValue(c, "paddingLeft")) || 1) / s, t.myParent.removeChild(c)
                                }
                                return null === q.remToPx && (q.remToPx = parseFloat(b.getPropertyValue(i.body, "fontSize")) || 16), null === q.vwToPx && (q.vwToPx = parseFloat(e.innerWidth) / 100, q.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = q.remToPx, l.vwToPx = q.vwToPx, l.vhToPx = q.vhToPx, g.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                            }
                            if (c.begin && 0 === T) try {
                                c.begin.call(m, m)
                            } catch (t) {
                            ...
                            if ("scroll" === P) {
                                ...
                                for (var M in _)
                                    if ("element" !== M) {
                                        var I = _[M].startValue;
                                        _[M].startValue = _[M].currentValue = _[M].endValue, _[M].endValue = I, h.isEmptyObject(k) || (_[M].easing = c.easing), g.debug && console.log("reverse tweensContainer (" + M + "): " + JSON.stringify(_[M]), r)
                                    } d = _
                            } else if ("start" === P) {
                                for (var D in a(r).tweensContainer && !0 === a(r).isAnimating && (_ = a(r).tweensContainer), u.each(y, function (t, e) {
                                    ...
                                    var $ = b.Hooks.getRoot(D),
                                        N = !1;
                                    if (a(r).isSVG || "tween" === $ || !1 !== b.Names.prefixCheck($)[1] || b.Normalizations.registered[$] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(D) && !j && 0 !== H && (j = 0), c._cacheValues && _ && _[D] ? (j === n && (j = _[D].endValue + _[D].unitType), N = a(r).rootPropertyValueCache[$]) : b.Hooks.registered[D] ? j === n ? (N = b.getPropertyValue(r, $), j = b.getPropertyValue(r, D, N)) : N = b.Hooks.templates[$][1] : j === n && (j = b.getPropertyValue(r, D));
                                        var W, F, Q, X = !1;
                                        if (j = (W = f(D, j))[0], Q = W[1], H = (W = f(D, H))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return X = e, ""
                                            }), F = W[1], j = parseFloat(j) || 0, H = parseFloat(H) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(D) ? (H /= 100, F = "em") : /^scale/.test(D) ? (H /= 100, F = "") : /(Red|Green|Blue)$/i.test(D) && (H = H / 100 * 255, F = "")), /[\/*]/.test(X)) F = Q;
                                        else if (Q !== F && 0 !== j)
                                            if (0 === H) F = Q;
                                            else {
                                                o = o || v();
                                                var R = /margin|padding|left|right|width|text|word|letter/i.test(D) || /X$/.test(D) || "x" === D ? "x" : "y";
                                                switch (Q) {
                                                    case "%":
                                                        j *= "x" === R ? o.percentToPxWidth : o.percentToPxHeight;
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                                ...
                                                switch (F) {
                                                    case "%":
                                                        j *= 1 / ("x" === R ? o.percentToPxWidth : o.percentToPxHeight);
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                    ...
                                    } else g.debug && console.log("Skipping [" + $ + "] due to a lack of browser support.")
                                }
                                d.element = r
                            }
                            d.element && (b.Values.addClass(r, "velocity-animating"), z.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, T === C - 1 ? (g.State.calls.push([z, m, c, null, A.resolver]), !1 === g.State.isTicking && (g.State.isTicking = !0, l())) : T++)
                        }
                        var o, r = this,
                        ...
                        switch (a(r) === n && g.init(r), parseFloat(c.delay) && !1 !== c.queue && u.queue(r, c.queue, function (t) {
                            ...
                            return !0 === i ? (A.promise && A.resolver(m), !0) : (g.velocityQueueEntryFlag = !0, void t())
                    ...
                    if (h.isWrapped(this) ? (d = !1, f = 0, m = this, p = this) : (d = !0, f = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = o(m)) {
                            ...
                            default:
                                if (!u.isPlainObject(y) || h.isEmptyObject(y)) {
                                    if (h.isString(y) && g.Redirects[y]) {
                                        var E = (D = u.extend({}, k)).duration,
                                            _ = D.delay || 0;
                                        return !0 === D.backwards && (m = u.extend(!0, [], m).reverse()), u.each(m, function (t, e) {
                                            parseFloat(D.stagger) ? D.delay = _ + parseFloat(D.stagger) * t : h.isFunction(D.stagger) && (D.delay = _ + D.stagger.call(e, t, C)), D.drag && (D.duration = parseFloat(E) || (/^(callout|transition)/.test(y) ? 1e3 : v), D.duration = Math.max(D.duration * (D.backwards ? 1 - t / C : (t + 1) / C), .75 * D.duration, 200)), g.Redirects[y].call(e, e, D || {}, t, C, m, A.promise ? A : n)
                                        }), t()
                                    }
                        ...
                        var I, D, q = {
                            ...
                            z = [];
                        if (u.each(m, function (t, e) {
                                h.isNode(e) && r.call(e)
                            }), (D = u.extend({}, g.defaults, k)).loop = parseInt(D.loop), I = 2 * D.loop - 1, D.loop)
                            for (var V = 0; I > V; V++) {
                                var H = {
                                    delay: D.delay,
                                    progress: D.progress
                                };
                                V === I - 1 && (H.display = D.display, H.visibility = D.visibility, H.complete = D.complete), w(m, "reverse", H)
                            }
                        return t()
                    }
                };
    ...
    function (t, e, i, n) {
        ...
        function B(t, e) {
            e = e || {}, this.options = l(e, Y.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = function (t) {
                ...
                return new(e || (at ? I : rt ? q : ot ? z : M))(t, T)
...
Materialize.throttle = function (t, e, i) {
    ...
    function (t) {
        t.fn.collapsible = function (e, i) {
            ...
            return e = t.extend(n, e), this.each(function () {
                ...
                function s(i, o) {
                    o || i.toggleClass("active"), e.accordion || "accordion" === r || void 0 === r ? function (e) {
                        a = n.find("> li > .collapsible-header"), e.hasClass("active") ? e.parent().addClass("active") : e.parent().removeClass("active"), e.parent().hasClass("active") ? e.siblings(".collapsible-body").stop(!0, !1).slideDown({
                            duration: 350,
                            easing: "easeOutQuart",
                            queue: !1,
                            complete: function () {
                        ...
                        }), a.not(e).removeClass("active").parent().removeClass("active"), a.not(e).parent().children(".collapsible-body").stop(!0, !1).each(function () {
                            t(this).is(":visible") && t(this).slideUp({
                                duration: 350,
                                easing: "easeOutQuart",
                                queue: !1,
                                complete: function () {
                                    t(this).css("height", ""), l(t(this).siblings(".collapsible-header"))
                                }
                            })
                        })
                    }(i) : function (e) {
                ...
                if ("destroy" !== o)
                    if (i >= 0 && i < a.length) {
                        var d = a.eq(i);
                        d.length && ("open" === o || "close" === o && d.hasClass("active")) && s(d)
                    } else u(), n.on("click.collapse", "> li > .collapsible-header", function (e) {
                        var i = t(e.target);
                        c(i).length > 0 && (i = c(i)), s(i)
                    }), e.accordion || "accordion" === r || void 0 === r ? s(a.filter(".active").first(), !0) : a.filter(".active").each(function () {
                        s(t(this), !0)
                    });
                else u()
            })
    ...
    function (t) {
        t.fn.scrollTo = function (e) {
            ...
            return "open" === e ? (this.each(function () {
                ...
                function l(e) {
                    "focus" === e && (a = !0), s(), r.addClass("active"), n.addClass("active");
                    var i = n[0].getBoundingClientRect().width;
                    !0 === o.constrainWidth ? r.css("width", i) : r.css("white-space", "nowrap");
                    var l = window.innerHeight,
                        u = n.innerHeight(),
                        d = n.offset().left,
                        p = n.offset().top - t(window).scrollTop(),
                        h = o.alignment,
                        f = 0,
                        v = 0,
                        m = 0;
                    ...
                    var g = 0,
                        y = 0,
                        b = n.parent();
                    if (b.is("body") || (b[0].scrollHeight > b[0].clientHeight && (g = b[0].scrollTop), b[0].scrollWidth > b[0].clientWidth && (y = b[0].scrollLeft)), d + r.innerWidth() > t(window).width() ? h = "right" : d - r.innerWidth() + n.innerWidth() < 0 && (h = "left"), p + r.innerHeight() > l)
                        if (p + u - r.innerHeight() < 0) {
                            var w = l - p - m;
                            r.css("max-height", w)
                        } else m || (m += u), m -= r.innerHeight();
                    if ("left" === h) f = o.gutter, v = n.position().left + f;
                    else if ("right" === h) {
                        r.stop(!0, !0).css({
                            opacity: 0,
                            left: 0
                        }), v = n.position().left + i - r.width() + (f = -o.gutter)
                    }
                    r.css({
                        position: "absolute",
                        top: n.position().top + m + g,
                        left: v + y
                    }), r.slideDown({
                        queue: !1,
                        ...
                        t(document).on("click." + r.attr("id"), function (e) {
                            c(), t(document).off("click." + r.attr("id"))
                        })
                    }, 0)
                }

                function c() {
                    a = !1, r.fadeOut(o.outDuration), r.removeClass("active"), n.removeClass("active"), t(document).off("click." + r.attr("id")), setTimeout(function () {
                        r.css("max-height", "")
                    }, o.outDuration)
                }
                if (s(), n.after(r), o.hover) {
                    var u = !1;
                    n.off("click." + n.attr("id")), n.on("mouseenter", function (t) {
                        !1 === u && (l(), u = !0)
                ...
                } else n.off("click." + n.attr("id")), n.on("click." + n.attr("id"), function (e) {
                    a || (n[0] != e.currentTarget || n.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? n.hasClass("active") && (c(), t(document).off("click." + r.attr("id"))) : (e.preventDefault(), o.stopPropagation && e.stopPropagation(), l("click")))
                });
            ...
            return this.each(function () {
                if (!t(this).hasClass("initialized")) {
                    ...
                    r.wrap(s), r.on("click", function () {
                        ...
                        if (!1 === o) return c(), !1;
                        if (n && !0 === o) return c(), !1;
                        o = !1, r.addClass("active"), n = !0, a.css({
                            width: a[0].getBoundingClientRect().width,
                            height: a[0].getBoundingClientRect().height,
                            position: "relative",
                            top: 0,
                            left: 0
                        }), e = void 0, i = a[0].parentNode;
                        for (; null !== i && !t(i).is(document);) {
                            var p = t(i);
                            "visible" !== p.css("overflow") && (p.css("overflow", "visible"), e = void 0 === e ? p : e.add(p)), i = i.parentNode
                        }
                        r.css({
                            position: "absolute",
                            "z-index": 1e3,
                        ...
                        if (h.css({
                            ...
                            v.text(r.data("caption")), t("body").append(v), v.css({
                                display: "inline"
                            }), v.velocity({
                                opacity: 1
                            }, {
                        ...
                        var m = 0,
                            g = 0;
                        u / s > d / l ? (m = .9 * s, g = .9 * s * (d / u)) : (m = .9 * l * (u / d), g = .9 * l), r.hasClass("responsive-img") ? r.velocity({
                            "max-width": m,
                            width: u
                        }, {
                            duration: 0,
                            ...
                            complete: function () {
                                r.css({
                                    ...
                                    height: g,
                                    width: m,
                                    left: t(document).scrollLeft() + s / 2 - r.parent(".material-placeholder").offset().left - m / 2,
                                    top: t(document).scrollTop() + l / 2 - r.parent(".material-placeholder").offset().top - g / 2
                                }, {
                                    duration: 275,
                                    queue: !1,
                                    easing: "easeOutQuad",
                ...
                function c() {
                    o = !1;
                    var i = r.parent(".material-placeholder"),
                        s = (window.innerWidth, window.innerHeight, r.data("width")),
                        c = r.data("height");
                    r.velocity("stop", !0), t("#materialbox-overlay").velocity("stop", !0), t(".materialbox-caption").velocity("stop", !0), t(window).off("scroll.materialbox"), t(document).off("keyup.materialbox"), t(window).off("resize.materialbox"), t("#materialbox-overlay").velocity({
                        opacity: 0
                    }, {
                        duration: a,
                        queue: !1,
                        ...
                        complete: function () {
                            i.css({
                                ...
                                top: "",
                                left: ""
                            }), r.removeAttr("style"), r.attr("style", l), r.removeClass("active"), o = !0, e && e.css("overflow", "")
                        }
    ...
    function (t) {
        t.fn.parallax = function () {
            ...
            return this.each(function (i) {
                ...
                function o(i) {
                    var o;
                    o = e < 601 ? n.height() > 0 ? n.height() : n.children("img").height() : n.height() > 0 ? n.height() : 500;
                    var a = n.children("img").first(),
                        r = a.height() - o,
                        s = n.offset().top + o,
                        l = n.offset().top,
                ...
                return this.each(function (i) {
                    ...
                    e.swipeable && u > e.responsiveThreshold && (e.swipeable = !1), 0 === (o = t(d.filter('[href="' + location.hash + '"]'))).length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass("active"), (v = d.index(o)) < 0 && (v = 0), void 0 !== o[0] && (a = t(o[0].hash)).addClass("active"), c.find(".indicator").length || c.append('<li class="indicator"></li>'), s = c.find(".indicator"), c.append(s), c.is(":visible") && setTimeout(function () {
                        ...
                        if (t(this).parent().hasClass("disabled")) i.preventDefault();
                            ...
                            var n = a;
                            o = t(this), a = t(Materialize.escapeHash(this.hash)), d = c.find("li.tab a");
                            o.position();
                            o.addClass("active"), m = v, (v = d.index(t(this))) < 0 && (v = 0), e.swipeable ? h.length && h.carousel("set", v, function () {
    ...
    function (t) {
        t.fn.tooltip = function (i) {
            return "remove" === i ? (this.each(function () {
                ...
                var n, o, a, r, s, l, c = Materialize.guid(),
                    u = t(this);
                u.attr("data-tooltip-id") && t("#" + u.attr("data-tooltip-id")).remove(), u.attr("data-tooltip-id", c);
                var d = function () {
                    n = u.attr("data-html") ? "true" === u.attr("data-html") : i.html, o = void 0 === (o = u.attr("data-delay")) || "" === o ? i.delay : o, a = void 0 === (a = u.attr("data-position")) || "" === a ? i.position : a, r = void 0 === (r = u.attr("data-tooltip")) || "" === r ? i.tooltip : r
                };
                d();
                var p;
                p = t('<div class="material-tooltip"></div>'), r = n ? t("<span></span>").html(r) : t("<span></span>").text(r), p.append(r).appendTo(t("body")).attr("id", c), (l = t('<div class="backdrop"></div>')).appendTo(p), s = p, u.off("mouseenter.tooltip mouseleave.tooltip");
                var h, f = !1;
                u.on({
                    "mouseenter.tooltip": function (t) {
                        h = setTimeout(function () {
                            d(), f = !0, s.velocity("stop"), l.velocity("stop"), s.css({
                                visibility: "visible",
                                left: "0px",
                                top: "0px"
                            });
                            var t, i, n, o, r, c, p = u.outerWidth(),
                                h = u.outerHeight(),
                                v = s.outerHeight(),
                                m = s.outerWidth(),
                                g = "0px",
                                ...
                                b = l[0].offsetWidth,
                                w = l[0].offsetHeight;
                            "top" === a ? (o = u.offset().top - v - 5, r = u.offset().left + p / 2 - m / 2, c = e(r, o, m, v), g = "-10px", l.css({
                                bottom: 0,
                                left: 0,
                                ...
                                marginTop: v,
                                marginLeft: m / 2 - b / 2
                            })) : "left" === a ? (o = u.offset().top + h / 2 - v / 2, r = u.offset().left - m - 5, c = e(r, o, m, v), y = "-10px", l.css({
                                top: "-7px",
                                right: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: v / 2,
                                marginLeft: m
                            })) : "right" === a ? (o = u.offset().top + h / 2 - v / 2, r = u.offset().left + p + 5, c = e(r, o, m, v), y = "+10px", l.css({
                                top: "-7px",
                                left: 0,
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: v / 2,
                                marginLeft: "0px"
                            })) : (o = u.offset().top + u.outerHeight() + 5, r = u.offset().left + p / 2 - m / 2, c = e(r, o, m, v), g = "+10px", l.css({
                                top: 0,
                                left: 0,
                                marginLeft: m / 2 - b / 2
                            })), s.css({
                                top: c.y,
                                left: c.x
                            }), t = Math.SQRT2 * m / parseInt(b), i = Math.SQRT2 * v / parseInt(w), n = Math.max(t, i), s.velocity({
                                translateY: g,
                                translateX: y
                            }, {
                                duration: 350,
                    ...
                    "mouseleave.tooltip": function () {
                        f = !1, clearTimeout(h), setTimeout(function () {
                            !0 !== f && (s.velocity({
                                opacity: 0,
                                translateY: 0,
                                translateX: 0
    ...
    function (t) {
        ...
        var o = {
                ...
                show: function (t, e) {
                    ...
                    var r, s, l, c, u, d = (c = {
                            top: 0,
                            left: 0
                        }, u = (r = i) && r.ownerDocument, s = u.documentElement, void 0 !== r.getBoundingClientRect && (c = r.getBoundingClientRect()), l = function (t) {
                            return null !== (e = t) && e === e.window ? t : 9 === t.nodeType && t.defaultView;
                            var e
                        }(u), {
                            top: c.top + l.pageYOffset - s.clientTop,
                            left: c.left + l.pageXOffset - s.clientLeft
                        }),
                        p = t.pageY - d.top,
                        h = t.pageX - d.left,
                        f = "scale(" + i.clientWidth / 100 * 10 + ")";
                    "touches" in t && (p = t.touches[0].pageY - d.top, h = t.touches[0].pageX - d.left), a.setAttribute("data-hold", Date.now()), a.setAttribute("data-scale", f), a.setAttribute("data-x", h), a.setAttribute("data-y", p);
                    var v = {
                        top: p + "px",
                        left: h + "px"
                    };
                    a.className = a.className + " waves-notransition", a.setAttribute("style", n(v)), a.className = a.className.replace("waves-notransition", ""), v["-webkit-transform"] = f, v["-moz-transform"] = f, v["-ms-transform"] = f, v["-o-transform"] = f, v.transform = f, v.opacity = "1", v["-webkit-transition-duration"] = o.duration + "ms", v["-moz-transition-duration"] = o.duration + "ms", v["-o-transition-duration"] = o.duration + "ms", v["transition-duration"] = o.duration + "ms", v["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", v["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", v["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", v["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", a.setAttribute("style", n(v))
                },
                hide: function (t) {
                    a.touchup(t);
                    var e = this,
            ...
            a = {
                ...
                allowEvent: function (t) {
                    ...
                    }, 500) : "mousedown" === t.type && a.touches > 0 && (e = !1), e
                },
                touchup: function (t) {
                    a.allowEvent(t)
                }
        ...
        function r(e) {
            ...
            null !== i && (o.show(e, i), "ontouchstart" in t && (i.addEventListener("touchend", o.hide, !1), i.addEventListener("touchcancel", o.hide, !1)), i.addEventListener("mouseup", o.hide, !1), i.addEventListener("mouseleave", o.hide, !1), i.addEventListener("dragend", o.hide, !1))
        }
        e.displayEffect = function (e) {
            "duration" in (e = e || {}) && (o.duration = e.duration), o.wrapInput(i(".waves-effect")), "ontouchstart" in t && document.body.addEventListener("touchstart", r, !1), document.body.addEventListener("mousedown", r, !1)
        }, e.attach = function (e) {
            "input" === e.tagName.toLowerCase() && (o.wrapInput([e]), e = e.parentNode), "ontouchstart" in t && e.addEventListener("touchstart", r, !1), e.addEventListener("mousedown", r, !1)
    ...
    function (t) {
                    ...
                    return t.each(i, function (t, i) {
                        if (i.height() > 0) {
                            var s = i.offset().top,
                                ...
                                c = l + i.width(),
                                u = s + i.height();
                            !(l > n || c < a || s > o || u < e) && r.push(i)
                        }
                    }), r
                }(s + r.top + o || 200, c + r.right, u + r.bottom, l + r.left);
            t.each(d, function (t, e) {
                "number" != typeof e.data("scrollSpy:ticks") && e.triggerHandler("scrollSpy:enter"), e.data("scrollSpy:ticks", a)
            }), t.each(n, function (t, e) {
                var i = e.data("scrollSpy:ticks");
                "number" == typeof i && i !== a && (e.triggerHandler("scrollSpy:exit"), e.data("scrollSpy:ticks", null))
            }), n = d
        }
        ...
        t.scrollSpy = function (n, a) {
            ...
            var l = [];
            (n = t(n)).each(function (e, n) {
                i.push(t(n)), t(n).data("scrollSpy:id", e), t('a[href="#' + t(n).attr("id") + '"]').click(function (e) {
                    e.preventDefault();
                    var i = t(Materialize.escapeHash(this.hash)).offset().top + 1;
                    t("html, body").animate({
                        scrollTop: i - a.scrollOffset
                    }, {
                        duration: 400,
                        queue: !1,
                        easing: "easeOutCubic"
            ...
            }), r.top = a.offsetTop || 0, r.right = a.offsetRight || 0, r.bottom = a.offsetBottom || 0, r.left = a.offsetLeft || 0;
            ...
            return o || (e.on("scroll", u), e.on("resize", u), o = !0), setTimeout(u, 0), n.on("scrollSpy:enter", function () {
                l = t.grep(l, function (t) {
                    return 0 != t.height()
                });
                var e = t(this);
                l[0] ? (t(a.getActiveElement(l[0].attr("id"))).removeClass(a.activeClass), e.data("scrollSpy:id") < l[0].data("scrollSpy:id") ? l.unshift(t(this)) : l.push(t(this))) : l.push(t(this)), t(a.getActiveElement(l[0].attr("id"))).addClass(a.activeClass)
            }), n.on("scrollSpy:exit", function () {
                if ((l = t.grep(l, function (t) {
                        return 0 != t.height()
                    }))[0]) {
                    t(a.getActiveElement(l[0].attr("id"))).removeClass(a.activeClass);
                    var e = t(this);
                    (l = t.grep(l, function (t) {
                        return t.attr("id") != e.attr("id")
                    }))[0] && t(a.getActiveElement(l[0].attr("id"))).addClass(a.activeClass)
                }
            }), n
            ...
            return t.winSizeSpy = function () {
                ...
                throttle: 100
            }, e.on("resize", Materialize.throttle(l, i.throttle || 100))
                    ...
                    if (t.isEmptyObject(o)) n.off("keyup.autocomplete focus.autocomplete");
                        ...
                        n.off("blur.autocomplete").on("blur.autocomplete", function () {
                            ...
                            if (13 !== r.which && 38 !== r.which && 40 !== r.which) {
                                if (i !== s && (u(), s.length >= e.minLength))
                                    for (var l in o)
                                        if (o.hasOwnProperty(l) && -1 !== l.toLowerCase().indexOf(s)) {
                                            if (a >= e.limit) break;
                                            var d = t("<li></li>");
                                            o[l] ? d.append('<img src="' + o[l] + '" class="right circle"><span>' + l + "</span>") : d.append("<span>" + l + "</span>"), c.append(d), p = s, f = void 0, v = void 0, m = void 0, g = void 0, y = void 0, b = void 0, f = (h = d).find("img"), v = h.text().toLowerCase().indexOf("" + p.toLowerCase()), m = v + p.length - 1, g = h.text().slice(0, v), y = h.text().slice(v, m + 1), b = h.text().slice(m + 1), h.html("<span>" + g + "<span class='highlight'>" + y + "</span>" + b + "</span>"), f.length && h.prepend(f), a++
                                        } var p, h, f, v, m, g, y, b;
                                i = s
                            }
        ...
        var e = {
            init: function (e) {
                return e = t.extend({
                    ...
                    function u(t) {
                        t >= s.length ? t = 0 : t < 0 && (t = s.length - 1), (l = r.find(".active").index()) != t && (i = s.eq(l), $caption = i.find(".caption"), i.removeClass("active"), i.velocity({
                            opacity: 0
                        }, {
                        ...
                        }), c($caption, e.transition), e.indicators && n.eq(l).removeClass("active"), s.eq(t).velocity({
                            opacity: 1
                        }, {
                            duration: e.transition,
                            queue: !1,
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), s.eq(t).addClass("active"), e.indicators && n.eq(t).addClass("active"))
                    } - 1 != l && (i = s.eq(l)), a.hasClass("fullscreen") || (e.indicators ? a.height(e.height + 40) : a.height(e.height), r.height(e.height)), s.find(".caption").each(function () {
                        c(t(this), 0)
                    ...
                    }), e.indicators && (n = t('<ul class="indicators"></ul>'), s.each(function (i) {
                        var a = t('<li class="indicator-item"></li>');
                        a.click(function () {
                            u(r.parent().find(t(this)).index()), clearInterval(o), o = setInterval(function () {
                                l = r.find(".active").index(), s.length == l + 1 ? l = 0 : l += 1, u(l)
                            }, e.transition + e.interval)
                        }), n.append(a)
                    }), a.append(n), n = a.find("ul.indicators").find("li.indicator-item")), i ? i.show() : (s.first().addClass("active").velocity({
                        opacity: 1
                    }, {
                        duration: e.transition,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), l = 0, i = s.eq(l), e.indicators && n.eq(l).addClass("active")), i.find("img").each(function () {
                    ...
                    a.hammer({
                        ...
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            var e, i = t.gesture.direction,
                                n = t.gesture.deltaX,
                                l = t.gesture.velocityX,
                                c = t.gesture.velocityY;
                            $curr_slide = r.find(".active"), Math.abs(l) > Math.abs(c) && $curr_slide.velocity({
                                translateX: n
                            }, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            }), 4 === i && (n > a.innerWidth() / 2 || l < -.65) ? p = !0 : 2 === i && (n < -1 * a.innerWidth() / 2 || l > .65) && (d = !0), d && (0 === (e = $curr_slide.next()).length && (e = s.first()), e.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                            })), p && (0 === (e = $curr_slide.prev()).length && (e = s.last()), e.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                        ...
                        "touch" === t.gesture.pointerType && ($curr_slide = r.find(".active"), !1, curr_index = r.find(".active").index(), !p && !d || s.length <= 1 ? $curr_slide.velocity({
                            translateX: 0
                        }, {
                            duration: 300,
                            queue: !1,
    ...
    function (t) {
        t.fn.pushpin = function (e) {
            ...
            return "remove" === e ? (this.each(function () {
                ...
                function r(i, n) {
                    i.each(function () {
                        e.top <= n && e.bottom >= n && !t(this).hasClass("pinned") && (a(t(this)), t(this).css("top", e.offset), t(this).addClass("pinned")), n < e.top && !t(this).hasClass("pin-top") && (a(t(this)), t(this).css("top", 0), t(this).addClass("pin-top")), n > e.bottom && !t(this).hasClass("pin-bottom") && (a(t(this)), t(this).addClass("pin-bottom"), t(this).css("top", e.bottom - o))
                    })
                }
                t(this).data("pushpin-id", i), r(n, t(window).scrollTop()), t(window).on("scroll." + i, function () {
    ...
    function (t) {
        ...
        function o(e, s, c, u) {
            ...
            var d = !1,
                ...
                h = c ? t.extend(!0, {}, c.defaults, u) : u || {},
                f = t.extend({}, o.klasses(), h.klass),
                v = t(e),
                m = function () {
                    return this.start()
                },
                g = m.prototype = {
                    ...
                    $node: v,
                    start: function () {
                        return p && p.start ? g : (p.methods = {}, p.start = !0, p.open = !1, p.type = e.type, e.autofocus = e == l(), e.readOnly = !h.editable, e.id = e.id || p.id, "text" != e.type && (e.type = "text"), g.component = new c(g, h), g.$root = t(o._.node("div", y(), f.picker, 'id="' + e.id + '_root" tabindex="0"')), g.$root.on({
                            keydown: b,
                            focusin: function (t) {
                                g.$root.removeClass(f.focused), t.stopPropagation()
                            },
                            "mousedown click": function (e) {
                                var i = e.target;
                                i != g.$root.children()[0] && (e.stopPropagation(), "mousedown" != e.type || t(i).is("input, select, textarea, button, option") || (e.preventDefault(), g.$root.eq(0).focus()))
                            }
                        }).on({
                            focus: function () {
                                v.addClass(f.target)
                            ...
                            blur: function () {
                                v.removeClass(f.target)
                            }
                        }).on("focus.toOpen", w).on("click", "[data-pick], [data-nav], [data-clear], [data-close]", function () {
                            var e = t(this),
                                i = e.data(),
                                n = e.hasClass(f.navDisabled) || e.hasClass(f.disabled),
                                o = l();
                            o = o && (o.type || o.href) && o, (n || o && !t.contains(g.$root[0], o)) && g.$root.eq(0).focus(), !n && i.nav ? g.set("highlight", g.component.item.highlight, {
                                nav: i.nav
                            }) : !n && "pick" in i ? (g.set("select", i.pick), h.closeOnSelect && g.close(!0)) : i.clear ? (g.clear(), h.closeOnSelect && g.close(!0)) : i.close && g.close(!0)
                        }), r(g.$root[0], "hidden", !0), h.formatSubmit && (!0 === h.hiddenName ? (a = e.name, e.name = "") : a = (a = ["string" == typeof h.hiddenPrefix ? h.hiddenPrefix : "", "string" == typeof h.hiddenSuffix ? h.hiddenSuffix : "_submit"])[0] + e.name + a[1], g._hidden = t('<input type=hidden name="' + a + '"' + (v.data("value") || e.value ? ' value="' + g.get("select", h.formatSubmit) + '"' : "") + ">")[0], v.on("change." + p.id, function () {
                            g._hidden.value = e.value ? g.get("select", h.formatSubmit) : ""
                        }), h.container ? t(h.container).append(g._hidden) : v.before(g._hidden)), v.data(s, g).addClass(f.input).attr("tabindex", -1).val(v.data("value") ? g.get("select", h.format) : e.value), h.editable || v.on("focus." + p.id + " click." + p.id, function (t) {
                            t.preventDefault(), g.$root.eq(0).focus()
                        }).on("keydown." + p.id, b), r(e, {
                            haspopup: !0,
                            expanded: !1,
                            readonly: !1,
                            owns: e.id + "_root"
                        }), h.container ? t(h.container).append(g.$root) : v.before(g.$root), g.on({
                            start: g.component.onStart,
                            render: g.component.onRender,
                            stop: g.component.onStop,
                            open: g.component.onOpen,
                            close: g.component.onClose,
                            set: g.component.onSet
                        }).on({
                            start: h.onStart,
                            render: h.onRender,
                            stop: h.onStop,
                            ...
                            close: h.onClose,
                            set: h.onSet
                        }), (i = g.$root.children()[0]).currentStyle ? n = i.currentStyle.position : window.getComputedStyle && (n = getComputedStyle(i).position), d = "fixed" == n, e.autofocus && g.open(), g.trigger("start").trigger("render"));
                        var i, n, a
                    },
                    render: function (t) {
                        return t ? g.$root.html(y()) : g.$root.find("." + f.box).html(g.component.nodes(p.open)), g.trigger("render")
                    },
                    stop: function () {
                        return p.start ? (g.close(), g._hidden && g._hidden.parentNode.removeChild(g._hidden), g.$root.remove(), v.removeClass(f.input).removeData(s), setTimeout(function () {
                            v.off("." + p.id)
                        }, 0), e.type = p.type, e.readOnly = !1, g.trigger("stop"), p.methods = {}, p.start = !1, g) : g
                    },
                    open: function (s) {
                        return p.open ? g : (v.addClass(f.active), r(e, "expanded", !0), setTimeout(function () {
                            g.$root.addClass(f.opened), r(g.$root[0], "hidden", !1)
                        }, 0), !1 !== s && (p.open = !0, d && n.css("overflow", "hidden").css("padding-right", "+=" + a()), g.$root.eq(0).focus(), i.on("click." + p.id + " focusin." + p.id, function (t) {
                            var i = t.target;
                            i != e && i != document && 3 != t.which && g.close(i === g.$root.children()[0])
                        }).on("keydown." + p.id, function (e) {
                            var i = e.keyCode,
                                n = g.component.key[i],
                                a = e.target;
                            27 == i ? g.close(!0) : a != g.$root[0] || !n && 13 != i ? t.contains(g.$root[0], a) && 13 == i && (e.preventDefault(), a.click()) : (e.preventDefault(), n ? o._.trigger(g.component.key.go, g, [o._.trigger(n)]) : g.$root.find("." + f.highlighted).hasClass(f.disabled) || (g.set("select", g.component.item.highlight), h.closeOnSelect && g.close(!0)))
                        })), g.trigger("open"))
                    },
                    close: function (t) {
                        return t && (g.$root.off("focus.toOpen").eq(0).focus(), setTimeout(function () {
                            g.$root.on("focus.toOpen", w)
                        }, 0)), v.removeClass(f.active), r(e, "expanded", !1), setTimeout(function () {
                            g.$root.removeClass(f.opened + " " + f.focused), r(g.$root[0], "hidden", !0)
                        }, 0), p.open ? (p.open = !1, d && n.css("overflow", "").css("padding-right", "-=" + a()), i.off("." + p.id), g.trigger("close")) : g
                    },
                    clear: function (t) {
                        return g.set("clear", null, t)
                    },
                    set: function (e, i, n) {
                        var o, a, r = t.isPlainObject(e),
                            s = r ? e : {};
                        if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
                            for (o in r || (s[e] = i), s) a = s[o], o in g.component.item && (void 0 === a && (a = null), g.component.set(o, a, n)), "select" != o && "clear" != o || v.val("clear" == o ? "" : g.get(o, h.format)).trigger("change");
                            g.render()
                        }
                        return n.muted ? g : g.trigger("set", s)
                    },
                    get: function (t, i) {
                        if (null != p[t = t || "value"]) return p[t];
                        if ("valueSubmit" == t) {
                            if (g._hidden) return g._hidden.value;
                            t = "value"
                        }
                        if ("value" == t) return e.value;
                        if (t in g.component.item) {
                            if ("string" == typeof i) {
                                var n = g.component.get(t);
                                return n ? o._.trigger(g.component.formats.toString, g.component, [i, n]) : ""
                            }
                            return g.component.get(t)
                        }
                    },
                    on: function (e, i, n) {
                        var o, a, r = t.isPlainObject(e),
            ...
            function y() {
                return o._.node("div", o._.node("div", o._.node("div", o._.node("div", g.component.nodes(p.open), f.box), f.wrap), f.frame), f.holder)
            }

            function b(t) {
                var e = t.keyCode,
                    i = /^(8|46)$/.test(e);
                if (27 == e) return g.close(), !1;
                (32 == e || i || !p.open && g.component.key[e]) && (t.preventDefault(), t.stopPropagation(), i ? g.clear().close() : g.open())
            }

            function w(t) {
                t.stopPropagation(), "focus" == t.type && g.$root.addClass(f.focused), g.open()
            }
            return new m
        }
        ...
        return o.klasses = function (t) {
            ...
            group: function (t) {
                for (var e, i = "", n = o._.trigger(t.min, t); n <= o._.trigger(t.max, t, [n]); n += t.i) e = o._.trigger(t.item, t, [n]), i += o._.node(t.node, e[0], e[1], e[2]);
                return i
            },
            ...
            t.fn[e] = function (n, a) {
                var r = this.data(e);
                return "picker" == n ? r : r && "string" == typeof n ? o._.trigger(r[n], r, [a]) : this.each(function () {
                    t(this).data(e) || new o(this, e, i, n)
                })
    ...
    function (t, e) {
        ...
        o.prototype.set = function (t, e, i) {
            ...
            var e, i, o = this,
                ...
                p = r.min,
                h = r.max,
                f = (e = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysLetter).slice(0), i = a.weekdaysFull.slice(0), a.firstDay && (e.push(e.shift()), i.push(i.shift())), n.node("thead", n.node("tr", n.group({
                    min: 0,
                    max: 6,
                    i: 1,
                    node: "th",
                ...
                v = function (t) {
                    return n.node("div", " ", a.klass["nav" + (t ? "Next" : "Prev")] + (t && u.year >= h.year && u.month >= h.month || !t && u.year <= p.year && u.month <= p.month ? " " + a.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + n.ariaAttr({
                        role: "button",
                ...
                m = function (e) {
                    ...
                    return "short_months" == e && (i = a.monthsShort), a.selectMonths && null == e ? n.node("select", n.group({
                        min: 0,
                        max: 11,
                        i: 1,
                        node: "option",
                        item: function (t) {
                            return [i[t], 0, "value=" + t + (u.month == t ? " selected" : "") + (u.year == p.year && t < p.month || u.year == h.year && t > h.month ? " disabled" : "")]
                        }
                    }), a.klass.selectMonth + " browser-default", (t ? "" : "disabled") + " " + n.ariaAttr({
                        controls: o.$node[0].id + "_table"
                    }) + ' title="' + a.labelMonthSelect + '"') : "short_months" == e ? null != l ? i[l.month] : i[u.month] : n.node("div", i[u.month], a.klass.month)
                },
                g = function (e) {
                    var i = u.year,
                    ...
                    if (r) {
                        var s = p.year,
                            ...
                            d = i - r,
                            f = i + r;
                        if (s > d && (f += s - d, d = s), c < f) {
                            var v = d - s,
                                m = f - c;
                            d -= v > m ? m : v, f = c
                        }
                        if (a.selectYears && null == e) return n.node("select", n.group({
                            min: d,
                            max: f,
                            i: 1,
                            node: "option",
                        ...
                        }), a.klass.selectYear + " browser-default", (t ? "" : "disabled") + " " + n.ariaAttr({
                            controls: o.$node[0].id + "_table"
                        }) + ' title="' + a.labelYearSelect + '"')
                    }
                    return "raw" === e && null != l ? n.node("div", l.year) : n.node("div", i, a.klass.year)
                };
            return createDayLabel = function () {
                return null != l ? l.date : s.date
            }, createWeekdayLabel = function () {
                var t;
                t = null != l ? l.day : s.day;
                var e = a.weekdaysShort[t];
                return e
            }, n.node("div", n.node("div", g("raw"), a.klass.year_display) + n.node("span", createWeekdayLabel() + ", ", "picker__weekday-display") + n.node("span", m("short_months") + " ", a.klass.month_display) + n.node("span", createDayLabel(), a.klass.day_display), a.klass.date_display) + n.node("div", n.node("div", n.node("div", (a.selectYears, m() + g() + v() + v(1)), a.klass.header) + n.node("table", f + n.node("tbody", n.group({
                min: 0,
                max: 5,
                i: 1,
                node: "tr",
                    ...
                    return [n.group({
                        ...
                        item: function (t) {
                            ...
                            var e, i = l && l.pick == t.pick,
                                r = c && c.pick == t.pick,
                                f = d && o.disabled(t) || t.pick < p.pick || t.pick > h.pick,
                                v = n.trigger(o.formats.toString, o, [a.format, t]);
                ...
                readonly: !0
            })), a.klass.calendar_container) + n.node("div", n.node("button", a.today, "btn-flat picker__today waves-effect", "type=button data-pick=" + s.pick + (t && !o.disabled(s) ? "" : " disabled") + " " + n.ariaAttr({
                controls: o.$node[0].id
            })) + n.node("button", a.clear, "btn-flat picker__clear waves-effect", "type=button data-clear=1" + (t ? "" : " disabled") + " " + n.ariaAttr({
                controls: o.$node[0].id
            })) + n.node("button", a.close, "btn-flat picker__close waves-effect", "type=button data-close=true " + (t ? "" : " disabled") + " " + n.ariaAttr({
                controls: o.$node[0].id
    ...
    function (t) {
        var e, i, n, o = t(window),
            a = t(document),
            r = "http://www.w3.org/2000/svg",
            s = "SVGAngle" in window && ((i = document.createElement("div")).innerHTML = "<svg/>", e = (i.firstChild && i.firstChild.namespaceURI) == r, i.innerHTML = "", e),
        ...
        function T(e, i) {
            var n, o, r = t(C),
                ...
                O = A ? e : e.find("input"),
                E = t("label[for=" + O.attr("id") + "]"),
                _ = this;
            this.id = (o = ++m + "", (n = "cp") ? n + o : o), this.element = e, this.holder = c, this.options = i, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = A, this.input = O, this.label = E, this.popover = r, this.plate = l, this.hoursView = h, this.minutesView = T, this.amPmBlock = P, this.spanHours = r.find(".clockpicker-span-hours"), this.spanMinutes = r.find(".clockpicker-span-minutes"), this.spanAmPm = r.find(".clockpicker-span-am-pm"), this.footer = r.find(".picker__footer"), this.amOrPm = "PM", i.twelvehour && (i.ampmclickable ? (this.spanAmPm.empty(), t('<div id="click-am">AM</div>').on("click", function () {
            ...
            }).appendTo(this.spanAmPm)) : (this.spanAmPm.empty(), t('<div id="click-am">AM</div>').appendTo(this.spanAmPm), t('<div id="click-pm">PM</div>').appendTo(this.spanAmPm))), t('<button type="button" class="btn-flat picker__clear" tabindex="' + (i.twelvehour ? "3" : "1") + '">' + i.cleartext + "</button>").click(t.proxy(this.clear, this)).appendTo(this.footer), t('<button type="button" class="btn-flat picker__close" tabindex="' + (i.twelvehour ? "3" : "1") + '">' + i.canceltext + "</button>").click(t.proxy(this.hide, this)).appendTo(this.footer), t('<button type="button" class="btn-flat picker__close" tabindex="' + (i.twelvehour ? "3" : "1") + '">' + i.donetext + "</button>").click(t.proxy(this.done, this)).appendTo(this.footer), this.spanHours.click(t.proxy(this.toggleView, this, "hours")), this.spanMinutes.click(t.proxy(this.toggleView, this, "minutes")), O.on("focus.clockpicker click.clockpicker", t.proxy(this.show, this));
            var M, I, D, q, z = t('<div class="clockpicker-tick"></div>');
            if (i.twelvehour)
                for (M = 1; M < 13; M += 1) I = z.clone(), D = M / 6 * Math.PI, q = y, I.css({
                    left: g + Math.sin(D) * q - w,
                    top: g - Math.cos(D) * q - w
                }), I.html(0 === M ? "00" : M), h.append(I), I.on(u, V);
            else
                for (M = 0; M < 24; M += 1) {
                    I = z.clone(), D = M / 6 * Math.PI, q = M > 0 && M < 13 ? b : y, I.css({
                        left: g + Math.sin(D) * q - w,
                        top: g - Math.cos(D) * q - w
                    }), I.html(0 === M ? "00" : M), h.append(I), I.on(u, V)
                }
            for (M = 0; M < 60; M += 5) I = z.clone(), D = M / 30 * Math.PI, I.css({
                left: g + Math.sin(D) * y - w,
                top: g - Math.cos(D) * y - w
            }), I.html(v(M)), T.append(I), I.on(u, V);
            ...
            function V(t, e) {
                var n = l.offset(),
                    ...
                    r = n.left + g,
                    s = n.top + g,
                    c = (o ? t.originalEvent.touches[0] : t).pageX - r,
                    u = (o ? t.originalEvent.touches[0] : t).pageY - s,
                    h = Math.sqrt(c * c + u * u),
                    f = !1;
                if (!e || !(h < y - w || h > y + w)) {
                    t.preventDefault();
                    ...
                    _.setHand(c, u, !e, !0), a.off(d).on(d, function (t) {
                        t.preventDefault();
                        var e = /^touch/.test(t.type),
                            i = (e ? t.originalEvent.touches[0] : t).pageX - r,
                            n = (e ? t.originalEvent.touches[0] : t).pageY - s;
                        (f || i !== c || n !== u) && (f = !0, _.setHand(i, n, !1, !0))
                    }), a.off(p).on(p, function (t) {
                        a.off(p), t.preventDefault();
                        var n = /^touch/.test(t.type),
                            o = (n ? t.originalEvent.changedTouches[0] : t).pageX - r,
                            h = (n ? t.originalEvent.changedTouches[0] : t).pageY - s;
                        (e || f) && o === c && h === u && _.setHand(o, h), "hours" === _.currentView ? _.toggleView("minutes", x / 2) : i.autoclose && (_.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                            _.done()
                        }, x / 2)), l.prepend(H), clearTimeout(v), _.popover.removeClass("clockpicker-moving"), a.off(d)
                    })
                }
            }
            if (l.on(u, function (e) {
                ...
                var H = r.find(".clockpicker-canvas"),
                    L = f("svg");
                L.setAttribute("class", "clockpicker-svg"), L.setAttribute("width", k), L.setAttribute("height", k);
                var j = f("g");
                j.setAttribute("transform", "translate(" + g + "," + g + ")");
                var $ = f("circle");
                $.setAttribute("class", "clockpicker-canvas-bearing"), $.setAttribute("cx", 0), $.setAttribute("cy", 0), $.setAttribute("r", 4);
                var N = f("line");
                N.setAttribute("x1", 0), N.setAttribute("y1", 0);
                var W = f("circle");
                W.setAttribute("class", "clockpicker-canvas-bg"), W.setAttribute("r", w), j.appendChild(N), j.appendChild(W), j.appendChild($), L.appendChild(j), H.append(L), this.hand = N, this.bg = W, this.bearing = $, this.g = j, this.canvas = H
            }
            S(this.options.init)
        }
        ...
        T.DEFAULTS = {
            ...
            if (!this.isShown) {
                ...
                if (this.options.twelvehour && void 0 !== n[1] && (n[1].indexOf("AM") > 0 ? this.amOrPm = "AM" : this.amOrPm = "PM", n[1] = n[1].replace("AM", "").replace("PM", "")), "now" === n[0]) {
                    ...
                    n = [r.getHours(), r.getMinutes()], this.options.twelvehour && (this.amOrPm = n[0] >= 12 && n[0] < 24 ? "PM" : "AM")
                }
                if (this.hours = +n[0] || 0, this.minutes = +n[1] || 0, this.spanHours.html(this.hours), this.spanMinutes.html(v(this.minutes)), !this.isAppended) {
                    ...
                    this.options.container && s ? s.appendChild(this.popover[0]) : this.popover.insertAfter(this.input), this.options.twelvehour && ("PM" === this.amOrPm ? (this.spanAmPm.children("#click-pm").addClass("text-primary"), this.spanAmPm.children("#click-am").removeClass("text-primary")) : (this.spanAmPm.children("#click-am").addClass("text-primary"), this.spanAmPm.children("#click-pm").removeClass("text-primary"))), o.on("resize.clockpicker" + this.id, function () {
                        i.isShown && i.locate()
                    }), this.isAppended = !0
                }
                this.toggleView("hours"), this.locate(), this.isShown = !0, a.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, function (e) {
                    var n = t(e.target);
            ...
            }), a.off("click.clockpicker." + this.id + " focusin.clockpicker." + this.id), a.off("keyup.clockpicker." + this.id), this.popover.hide(), S(this.options.afterHide)
            ...
            }, x), n && S(this.options.afterHourSelect)
        ...
        }, T.prototype.setHand = function (e, i, n, o) {
            var a, r = Math.atan2(e, -i),
                ...
                p = l && u < (y + b) / 2,
                f = p ? b : y;
            if (d.twelvehour && (f = y), r < 0 && (r = 2 * Math.PI + r), r = (a = Math.round(r / c)) * c, d.twelvehour ? l ? 0 === a && (a = 12) : (n && (a *= 5), 60 === a && (a = 0)) : l ? (12 === a && (a = 0), a = p ? 0 === a ? 12 : a : 0 === a ? 0 : a + 12) : (n && (a *= 5), 60 === a && (a = 0)), this[this.currentView] !== a && h && this.options.vibrate && (this.vibrateTimer || (navigator[h](10), this.vibrateTimer = setTimeout(t.proxy(function () {
                    this.vibrateTimer = null
                }, this), 100))), this[this.currentView] = a, l ? this.spanHours.html(a) : this.spanMinutes.html(v(a)), s) {
                var m = Math.sin(r) * (f - w),
                    g = -Math.cos(r) * (f - w),
                    k = Math.sin(r) * f,
                    x = -Math.cos(r) * f;
            ...
            return this.each(function () {
                ...
                if (o) "function" == typeof o[e] && o[e].apply(o, i);
                    ...
                    var a = t.extend({}, T.DEFAULTS, n.data(), "object" == typeof e && e);
        ...
        t.fn.characterCounter = function () {
            return this.each(function () {
                ...
                n.parent().find('span[class="character-counter"]').length || void 0 !== n.attr("data-length") && (n.on("input", e), n.on("focus", e), n.on("blur", i), function (e) {
                    ...
                    if (i.length) return;
                    i = t("<span/>").addClass("character-counter").css("float", "right").css("font-size", "12px").css("height", 1), e.parent().append(i)
                }(n))
            })
        }, t(document).ready(function () {
        ...
        var e = {
            init: function (e) {
                ...
                return this.each(function (n) {
                    var o, a, r, s, l, c, u, d, p, h, f, v, m, g, b, w, k, x, C, T = t('<ul class="indicators"></ul>'),
                        S = null,
                        P = null,
                        A = t(this),
                        O = A.find(".carousel-item").length > 1,
                        E = (A.attr("data-indicators") || e.indicators) && O,
                        _ = A.attr("data-no-wrap") || e.noWrap || !O,
                        M = A.attr("data-namespace") || i + n;
                    A.attr("data-namespace", M);
                    var I = function (e) {
                        var i = A.find(".carousel-item.active").length ? A.find(".carousel-item.active").first() : A.find(".carousel-item").first(),
                            n = i.find("img").first();
                        if (n.length)
                            if (n[0].complete)
                                if (n.height() > 0) A.css("height", n.height());
                                else {
                    ...
                    if (e.fullWidth && (e.dist = 0, I(), E && A.find(".carousel-fixed-item").addClass("with-indicators")), A.hasClass("initialized")) return t(window).trigger("resize"), A.trigger("carouselNext", [1e-6]), !0;
                    ...
                    function z(t) {
                        return t >= d ? t % d : t < 0 ? z(d + t % d) : t
                    }

                    function V(i) {
                        var n, c, p, h, f, v, m;
                        !0, A.hasClass("scrolling") || A.addClass("scrolling"), null != S && window.clearTimeout(S), S = window.setTimeout(function () {
                            !1, A.removeClass("scrolling")
                        }, e.duration);
                        var y = l;
                        if (s = "number" == typeof i ? i : s, l = Math.floor((s + u / 2) / u), f = -(h = (p = s - l * u) < 0 ? 1 : -1) * p * 2 / u, c = d >> 1, e.fullWidth ? m = "translateX(0)" : (m = "translateX(" + (A[0].clientWidth - a) / 2 + "px) ", m += "translateY(" + (A[0].clientHeight - r) / 2 + "px)"), E) {
                            var b = l % d,
                                w = T.find(".indicator-item.active");
                            w.index() !== b && (w.removeClass("active"), T.find(".indicator-item").eq(b).addClass("active"))
                        }
                        for ((!_ || l >= 0 && l < d) && (v = o[z(l)], t(v).hasClass("active") || (A.find(".carousel-item").removeClass("active"), t(v).addClass("active")), v.style[g] = m + " translateX(" + -p / 2 + "px) translateX(" + h * e.shift * f * n + "px) translateZ(" + e.dist * f + "px)", v.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * f, v.style.opacity = tweenedOpacity, v.style.display = "block"), n = 1; n <= c; ++n) e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === c && p < 0 ? 1 - f : 1) : (zTranslation = e.dist * (2 * n + f * h), tweenedOpacity = 1 - .2 * (2 * n + f * h)), (!_ || l + n < d) && ((v = o[z(l + n)]).style[g] = m + " translateX(" + (e.shift + (u * n - p) / 2) + "px) translateZ(" + zTranslation + "px)", v.style.zIndex = -n, v.style.opacity = tweenedOpacity, v.style.display = "block"), e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === c && p > 0 ? 1 - f : 1) : (zTranslation = e.dist * (2 * n - f * h), tweenedOpacity = 1 - .2 * (2 * n - f * h)), (!_ || l - n >= 0) && ((v = o[z(l - n)]).style[g] = m + " translateX(" + (-e.shift + (-u * n - p) / 2) + "px) translateZ(" + zTranslation + "px)", v.style.zIndex = -n, v.style.opacity = tweenedOpacity, v.style.display = "block");
                        if ((!_ || l >= 0 && l < d) && ((v = o[z(l)]).style[g] = m + " translateX(" + -p / 2 + "px) translateX(" + h * e.shift * f + "px) translateZ(" + e.dist * f + "px)", v.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * f, v.style.opacity = tweenedOpacity, v.style.display = "block"), y !== l && "function" == typeof e.onCycleTo) {
                            var k = A.find(".carousel-item").eq(z(l));
                            e.onCycleTo.call(this, k, x)
                        }
                        "function" == typeof P && (P.call(this, k, x), P = null)
                    }

                    function H() {
                        var t, e, i;
                        e = (t = Date.now()) - w, w = t, i = s - b, b = s, m = .8 * (1e3 * i / (1 + e)) + .2 * m
                    }

                    function L() {
                        var t, i;
                        f && (t = Date.now() - w, (i = f * Math.exp(-t / e.duration)) > 2 || i < -2 ? (V(v - i), requestAnimationFrame(L)) : V(v))
                    }

                    function j(i) {
                        if (x) return i.preventDefault(), i.stopPropagation(), !1;
                        if (!e.fullWidth) {
                            var n = t(i.target).closest(".carousel-item").index();
                            0 !== z(l) - n && (i.preventDefault(), i.stopPropagation()), $(n)
                        }
                    }

                    function $(t) {
                        var e = l % d - t;
                        _ || (e < 0 ? Math.abs(e + d) < Math.abs(e) && (e += d) : e > 0 && Math.abs(e - d) < e && (e -= d)), e < 0 ? A.trigger("carouselNext", [Math.abs(e)]) : e > 0 && A.trigger("carouselPrev", [e])
                    }

                    function N(e) {
                        "mousedown" === e.type && t(e.target).is("img") && e.preventDefault(), c = !0, x = !1, C = !1, p = D(e), h = q(e), m = f = 0, b = s, w = Date.now(), clearInterval(k), k = setInterval(H, 100)
                    }

                    function W(t) {
                        var e, i;
                        if (c)
                            if (e = D(t), y = q(t), i = p - e, Math.abs(h - y) < 30 && !C)(i > 2 || i < -2) && (x = !0, p = e, V(s + i));
                            else {
                                if (x) return t.preventDefault(), t.stopPropagation(), !1;
                                C = !0
                            } if (x) return t.preventDefault(), t.stopPropagation(), !1
                    }

                    function F(t) {
                        if (c) return c = !1, clearInterval(k), v = s, (m > 10 || m < -10) && (v = s + (f = .9 * m)), v = Math.round(v / u) * u, _ && (v >= u * (d - 1) ? v = u * (d - 1) : v < 0 && (v = 0)), f = v - s, w = Date.now(), requestAnimationFrame(L), x && (t.preventDefault(), t.stopPropagation()), !1
                    }
                    A.addClass("initialized"), c = !1, s = v = 0, o = [], a = A.find(".carousel-item").first().innerWidth(), r = A.find(".carousel-item").first().innerHeight(), u = 2 * a + e.padding, A.find(".carousel-item").each(function (e) {
                        if (o.push(t(this)[0]), E) {
                            var i = t('<li class="indicator-item"></li>');
                            0 === e && i.addClass("active"), i.click(function (e) {
                                e.stopPropagation(), $(t(this).index())
                            }), T.append(i)
                        }
                    }), E && A.append(T), d = o.length, g = "transform", ["webkit", "Moz", "O", "ms"].every(function (t) {
                        var e = t + "Transform";
                        return void 0 === document.body.style[e] || (g = e, !1)
                    });
                    var Q = Materialize.throttle(function () {
                        if (e.fullWidth) {
                            a = A.find(".carousel-item").first().innerWidth();
                            A.find(".carousel-item.active").height();
                            u = 2 * a + e.padding, v = s = 2 * l * a, I(!0)
                        } else V()
                    }, 200);
                    t(window).off("resize.carousel-" + M).on("resize.carousel-" + M, Q), void 0 !== window.ontouchstart && (A.on("touchstart.carousel", N), A.on("touchmove.carousel", W), A.on("touchend.carousel", F)), A.on("mousedown.carousel", N), A.on("mousemove.carousel", W), A.on("mouseup.carousel", F), A.on("mouseleave.carousel", F), A.on("click.carousel", j), V(s), t(this).on("carouselNext", function (t, e, i) {
                        void 0 === e && (e = 1), "function" == typeof i && (P = i), v = u * Math.round(s / u) + u * e, s !== v && (f = v - s, w = Date.now(), requestAnimationFrame(L))
                    }), t(this).on("carouselPrev", function (t, e, i) {
                        void 0 === e && (e = 1), "function" == typeof i && (P = i), v = u * Math.round(s / u) - u * e, s !== v && (f = v - s, w = Date.now(), requestAnimationFrame(L))
                    }), t(this).on("carouselSet", function (t, e, i) {
                        void 0 === e && (e = 0), "function" == typeof i && (P = i), $(e)
                    })
                })
            },
            next: function (e, i) {
